...
export default function IsItSafe() {
  ...
  // Dynamic Initial Mount Analysis
  useEffect(() => {
    const runInitialAnalysis = async () => {
      setIsAnalyzing(true);
      const res = await analyzeDestinationSafetyWithAI(formData);
  ...
  const scoreConfig = report ? getScoreColorClasses(report.safetyScore) : getScoreColorClasses(90);
          ...
          <div className="flex flex-col gap-3">
            {history.length === 0 ? (
              <div className="p-4 rounded-xl bg-slate-50 text-center text-xs text-[#666C68]">
                No previous analyses logged yet.
              </div>
            ) : (
              history.map((item) => (
                <div
        ...
        <div className="flex flex-col gap-14 animate-in fade-in duration-300">
          ...
          <section className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {report.riskBreakdown?.personalSafety && (
              ...
              {report.riskBreakdown?.transportation && (
                <div className="editorial-white-card p-7 flex flex-col justify-between gap-4">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-10 h-10 rounded-xl bg-[#1D2B26] text-white flex items-center justify-center shadow-sm">
                    ...
                    <h3 className="text-base font-bold text-[#222926] font-heading mb-2">
                      Transportation ({formData.travelMode})
                    </h3>
                    <p className="text-xs text-[#666C68] leading-relaxed font-normal">
              ...
              {report.riskBreakdown?.environmental && (
                <div className="editorial-white-card p-7 flex flex-col justify-between gap-4">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-10 h-10 rounded-xl bg-[#1D2B26] text-white flex items-center justify-center shadow-sm">
              ...
              {report.riskBreakdown?.crowdLevel && (
                <div className="editorial-white-card p-7 flex flex-col justify-between gap-4">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-10 h-10 rounded-xl bg-[#1D2B26] text-white flex items-center justify-center shadow-sm">
              ...
              {report.riskBreakdown?.generalAdvice && (
